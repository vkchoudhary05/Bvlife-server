...
try {
  ...
  if (appOrigin && appOrigin !== 'null') {
    ...
    if (appUrl.hostname === 'bvlife.in') allowedOrigins.add(`${appUrl.protocol}//www.bvlife.in`);
    if (appUrl.hostname === 'www.bvlife.in') allowedOrigins.add(`${appUrl.protocol}//bvlife.in`);
  }
} catch {
