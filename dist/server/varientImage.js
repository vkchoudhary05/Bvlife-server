 ...
 */
export const FORMULATION_PRESET_IMAGES = [
    {
        id: 'tablet',
...
export function detectFormulationType(variant, parentProduct) {
    if (!variant)
        return 'tablet';
    const combinedText = [
        variant.form || '',
...
export function getVariantImage(variant, parentProduct) {
...
export function getVariantGalleryImages(variant, parentProduct) {
    const result = [];
    const addImage = (img) => {
