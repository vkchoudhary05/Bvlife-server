...
export class AppointmentService {
    ...
    bookAppointment(data) {
        const { doctorId, patientName, patientAge, patientGender, patientPhone, patientEmail, date, timeSlot, consultationMode, healthConcern, previousHistory, medicalReports, fee } = data;
     ...
     */
    updateMeetingLink(id, meetingLink, meetingPlatform) {
        if (!meetingLink) {
     ...
     */
    updateRoomStatus(id, roomStatus) {
