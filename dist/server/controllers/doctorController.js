...
export const bookDoctorAppointment = async (req, res) => {
    try {
        const { doctorId, patientName, patientAge, patientGender, patientPhone, patientEmail, date, timeSlot, consultationMode, healthConcern, previousHistory, medicalReports, fee } = req.body;
